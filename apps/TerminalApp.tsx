...
const TerminalApp: React.FC = () => {
    ...
    const handleInputKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        if (e.key === 'Enter') {
            ...
            // Execute side effects AFTER all history state updates are queued
    ...
    return (
        <div 
            className="h-full bg-black text-green-400 font-mono text-sm focus:outline-none flex flex-col" 
        ...
        >
            ...
            <div className="flex items-center p-3 pt-0 flex-shrink-0">
                ...
                <input
                    ...
                    className="flex-grow bg-transparent border-none outline-none text-green-400 ml-2"
                    autoFocus
                    spellCheck="false"
                />
