        ...
        const fetchApodData = async () => {
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    let errorMessage = errorData.msg || 'Failed to fetch data from NASA API.';
                    
                    if (response.status === 429) { // Rate limit exceeded
                        errorMessage = `The NASA API key is rate-limited. If you're using the DEMO_KEY, please get a personal key from api.nasa.gov.`;
                    } else if (response.status === 403) { // Forbidden / Invalid Key
                        ...
                        // Specific handling for the API's "no data" error for better UX
