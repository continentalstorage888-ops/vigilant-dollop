...
import { UserCircle2, FolderGit2, AtSign, Palette, Bot, TerminalSquare, FileText, HardDrive, Target, Grid3x3, Gamepad2, Hand, LayoutGrid, Hash, Puzzle, FlaskConical, Users, LockKeyhole, Contact2, Sparkles, Newspaper, FileCode2, AreaChart, FilePieChart, Telescope, Orbit, type LucideProps } from 'lucide-react';
...
// Define which apps should appear on the desktop
export const DESKTOP_APP_IDS: AppID[] = ['file_explorer', 'reader', 'hire_me', 'projects', 'about', 'articles', 'case_studies', 'astro_viewer', 'astro_tracker'];

// Define which apps should appear in the dock
export const DOCK_APPS: AppDefinition[] = APPS.filter(app => 
    !['reader', 'file_explorer', 'hire_me', 'tic_tac_toe', 'games_folder', 'rock_paper_scissors', 'connect_four', 'guess_the_number', 'hangman', 'skills_playground', 'work_with_me', 'secret_projects', 'business_card', 'skills_interests', 'about', 'projects', 'articles', 'editor', 'data_wave_dashboard', 'case_studies', 'astro_viewer', 'astro_tracker'].includes(app.id)
);
